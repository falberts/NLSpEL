...
detokenize = MosesDetokenizer('nl')
...
class PhraseAnnotation:
    def __init__(self, initial_word):
        ...
        self.multinerd_candidates = initial_word.multinerd_candidates
    ...
    def add(self, word):
        ...
        if self._resolved_annotation > 0 and self.multinerd_candidates != word.multinerd_candidates:
            self.multinerd_candidates = list(set(self.multinerd_candidates) & set(word.multinerd_candidates))
...
class WordAnnotation:
    def __init__(self, subword_annotations, token_offsets, multinerd_candidates=None):
        if multinerd_candidates is None:
            multinerd_candidates = []
        self.annotations = subword_annotations
        self.token_offsets = token_offsets
        self.multinerd_candidates = multinerd_candidates
