...
Note: this code has not been used for NLSpEL, and has oonly been left in to potentially be adapted to work in the future.
...
def load_model():
    ...
    if load_multinerd_finetuned and not load_full_vocabulary:
        model.shrink_classification_head_to_multinerd(device=device)
