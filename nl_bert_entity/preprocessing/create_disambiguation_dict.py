...
class CreateDisambiguationDict(PipelineJob):
    ...
    def __init__(self, preprocess_jobs: Dict[str, PipelineJob], opts):
        super().__init__(
            ...
            provides=[
                ...
                "data/downloads/disambiguations_lang=nl.ttl.bz2",
            ],
    ...
    def _run(self):
        ...
        fb_to_wikiname_dict = self._create_dict(
            redirects=redirects,
            url="https://downloads.dbpedia.org/repo/dbpedia/generic/disambiguations/2022.12.01/disambiguations_lang=nl.ttl.bz2",
            matcher_pattern="<http://nl.dbpedia.org/resource/(.*)> <http://dbpedia.org/ontology/wikiPageDisambiguates> <http://nl.dbpedia.org/resource/(.*)> .",
        )
        with open("data/indexes/disambiguations_lang=nl.ttl.bz2.dict", "wb") as f:
