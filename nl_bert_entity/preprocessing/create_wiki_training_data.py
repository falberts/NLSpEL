    ...
    def extract_data(self, file_name):
        ...
        with io.open(file_name) as f:
            ...
            for i, wiki_article in enumerate(f.readlines()):
                ...
                wiki_article_title_entity = self.redirects_nl.get(
                ...
                for char_idx, char in enumerate(list(wiki_article["text"])):
                    ...
                    if links_seen < len(links_offsets) and (
                        ...
                        entity = self.redirects_nl.get(normalized_wiki_entity, normalized_wiki_entity)
                    ...
                    if links_seen < len(links_offsets) and (
                        ...
                        # normalized_wiki_entity = normalize_wiki_entity(links_offsets[links_seen][1][1], replace_ws=True)
                        # entity = redirects_nl.get(normalized_wiki_entity, normalized_wiki_entity)
                ...
                current_snippet_tokenized = self.tokenizer.tokenize(current_snippet)[:512]
