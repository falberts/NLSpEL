...
class CreateIntegerizedCONLLTrainingData(PipelineJob):
    def __init__(self, preprocess_jobs: Dict[str, PipelineJob], opts):
        super().__init__(
            ...
            provides=[f"data/benchmarks/multinerd-dataset/multinerd_dataset_{opts.data_version_name}_{opts.create_integerized_training_instance_text_length}-{opts.create_integerized_training_instance_text_overlap}.pickle",],
    ...
    def _run(self):
        ...
        with open("data/benchmarks/multinerd-dataset/multinerd_dataset.pickle", "rb") as f:
        ...
        tokenizer = XLMRobertaTokenizerFast.from_pretrained("FacebookAI/xlm-roberta-base", do_lower_case=True, is_split_into_words=True, add_prefix_space=True)
        ...
        with open(f"data/benchmarks/multinerd-dataset/dataset_{self.opts.data_version_name}"
