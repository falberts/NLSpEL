...
from spel.utils import store_validation_data_wiki, chunk_annotate_and_merge_to_phrase, \
    get_multinerd_set_phrase_splitted_documents, compare_gold_and_predicted_annotation_documents, fix_problematic_cases
...
class SpELAnnotator:
    ...
    def load_checkpoint(self, checkpoint_name, device="cpu", rank=0):
        if rank == 0:
