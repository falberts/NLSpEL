...
The expected sizes of the auto-downloaded datasets:
    - Step 1 (general knowledge fine-tuning):
            ...
            * directory as well                                                                                       *
            * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    - Step 2 (MultiNERD fine-tuning):
            multinerd.tar.gz: 35.5 MBs
...
def get_dataset(dataset_name: str, split: str, batch_size: int, get_labels_with_high_model_score=None,
    ...
    dset_class =  wikipedia_dataset if dataset_name == "nlwiki" else multinerd_dataset
    d_size =  wikipedia_dataset_config.NUM_LINES[split] \
